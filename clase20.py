...
def read_data(filepath="./numbers/data.txt"):
    words = []
...
def run():
    data = read_data(filepath="./numbers/data.txt")
...
#Las palabras para que funcione el programa se la debe colocar en el archivo data.txt
